...
import { X, Eye, BookOpen, Calendar } from "lucide-react";
...
function CatalogoDocumento({
  ...
  return (
    ...
    >
      <div className="sticky top-0 z-10 flex items-center justify-between gap-2 bg-background border-b px-6 py-3">
      ...
      <div className="max-w-[210mm] mx-auto my-6 sm:my-10">
        <div
        ...
        {catalogo.obras.map((obra, index) => {
          ...
          return (
            <div
              key={obra.id}
              className="bg-white text-black p-8 sm:p-12 mt-1"
              data-testid={`catalogo-obra-${obra.id}`}
            >
              {index > 0 && <Separator className="bg-black/10 mb-8" />}
        ...
        <div className="bg-white text-black p-8 sm:p-12 mt-1">
